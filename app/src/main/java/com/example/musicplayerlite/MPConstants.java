...
public class MPConstants {
    public static final String PACKAGE_NAME = "com.example.musicplayerlite";
    public static final String DEBUG_TAG = "MPLite_debug";
    public static final String GITHUB_REPO_URL = "https://github.com/AP-example/music_player_lite";

    public static final int PERMISSION_READ_STORAGE = 1009;

    public static final String MEDIA_SESSION_TAG = "com.example.musicplayerlite.MediaSession";

    public static final int NOTIFICATION_ID = 101;
    public static final String PLAY_PAUSE_ACTION = "com.example.musicplayerlite.PLAYPAUSE";
    public static final String NEXT_ACTION = "com.example.musicplayerlite.NEXT";
    public static final String PREV_ACTION = "com.example.musicplayerlite.PREV";
    public static final String CLOSE_ACTION = "com.example.musicplayerlite.CLOSE";
    public static final String CHANNEL_ID = "com.example.musicplayerlite.CHANNEL_ID";
